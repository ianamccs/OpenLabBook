...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "Movement Detector"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<MovementDetector>); //Class factory pointer. Replace "MovementDetector" with the name of your class.
		break;
/**
