...
#ifndef MOVEMENTDETECTOREDITOR_H_INCLUDED
#define MOVEMENTDETECTOREDITOR_H_INCLUDED
...
class MovementDetectorEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders. 
