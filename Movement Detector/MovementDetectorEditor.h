...
/**
   User interface for MovementDetector Processor.

   @see MovementDetector
*/
...
{
public:
    MovementDetectorEditor (GenericProcessor* parentProcessor, bool useDefaultParameterEditors);
